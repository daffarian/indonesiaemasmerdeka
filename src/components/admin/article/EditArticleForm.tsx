...
// submit article
import updateArticle from "@/lib/action/updateArticle";
...
export default function EditArticleForm({
  ...
  const [preview, setPreview] = useState<string>(article.image_url);
  ...
  const handelSubmit = async (formData: FormData) => {
    updateArticle(formData, article.slug, quill?.getSemanticHTML());
  };
